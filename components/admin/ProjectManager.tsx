...
//   return (
//     <section className="rounded-3xl mt-20 border border-white/70 bg-white/80 p-6 shadow-[0_20px_60px_rgba(0,168,232,0.12)] backdrop-blur-xl">
...
//                         rel="noreferrer"
//                       >
//                         <FaGithub size={17} className="hover:text-slate-700" />
//                       </a>
//                     )}
//                     {project.liveLink && (
//                       <a
