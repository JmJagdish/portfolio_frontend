...
export default function AboutMe() {
  return (
    <section id="about" className="relative overflow-hidden bg-[#f8fbff] pt-20 sm:py-24">
      
      <div className="absolute top-0 left-1/2 h-80 w-80 -translate-x-1/2 rounded-full bg-[#00a8e8]/20 blur-3xl" />

      <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
        <h2 className="my-14 text-center text-3xl font-bold text-slate-900 sm:text-4xl lg:text-5xl">
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-20">
          ...
          <div className="order-2 my-10 rounded-3xl border border-white/70 bg-white/80 p-8 shadow-[0_20px_60px_rgba(0,168,232,0.10)] backdrop-blur-xl lg:order-1 sm:p-10">
            ...
            <div className="mt-10">
              <h3 className="mb-6 text-lg font-bold text-slate-800">Contact</h3>
              ...
              <div className="space-y-5">
                {contactInfo.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="flex items-center gap-4 rounded-2xl border border-white bg-[#f8fbff] px-5 py-4 shadow-sm transition hover:shadow-md"
                    >
          ...
          <div className="order-1 flex justify-center lg:order-2">
            <div className="relative h-80 w-80 rounded-4xl bg-white p-2 shadow-[0_20px_60px_rgba(0,168,232,0.20)] sm:h-96 sm:w-96">
